  ...
  var gemeinsam = {
    de: {
      ...
      befunde: {
        ...
        RC3: "Reverse Charge gibt es nur im EU-Ausland. Für ein Drittland: „nicht steuerbar“ bei Leistungen, „Ausfuhr“ bei Waren.",
        O1: "„Nicht steuerbar“ lässt sich nicht mit anderen Steuersätzen auf einer Rechnung mischen — bitte zwei Rechnungen.",
        O2: "Bei „nicht steuerbar“ darf die USt-IdNr. nicht auf der Rechnung stehen — dafür braucht es Ihre Steuernummer in den Stammdaten.",
    ...
    en: {
      ...
      befunde: {
        ...
        RC3: "Reverse charge applies within the EU only. For a third country use “not taxable” for services, “export” for goods.",
        O1: "“Not taxable” cannot be mixed with other VAT rates on one invoice — please split it in two.",
        O2: "With “not taxable” the VAT ID must not appear on the invoice — your tax number in the master data is required instead.",
